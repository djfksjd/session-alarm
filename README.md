...
<p align="center">
  ...
  <a href="SOUND_LICENSE.md"><img alt="Verified mixed audio provenance" src="https://img.shields.io/badge/audio-verified_provenance-00AB6B?style=flat-square"></a>
...
The 40 built-in choices contain 39 deterministic animal-themed notification tones generated by
this project and one independently verified Pixabay elephant recording. Every bundled file has a
SHA-256 entry and file-level license record in the provenance manifest. You can also import a WAV
you created or are licensed to use.
...
<table>
  <tr>
    ...
    <td width="25%" align="center"><strong>🛡️ Auditable audio</strong><br>Generator seeds or exact source provenance, licenses, and checksums are documented.</td>
...
> [!IMPORTANT]
> Thirty-nine built-in files are original generated tones under MIT. The elephant file is Pixabay
> content under its own license and must not be extracted or redistributed as standalone stock audio.
...
Contributions are welcome; read [CONTRIBUTING.md](CONTRIBUTING.md). Generated sounds must remain
reproducible; external sounds require an exact asset URL, contributor, license verification, and
checksum.

## License

Code, documentation, and 39 project-generated WAV files are released under the
[MIT License](LICENSE). The elephant WAV remains under the
[Pixabay Content License](SOUND_LICENSE.md). See [third-party notices](THIRD_PARTY_NOTICES.md).
